...
Code: `etl/build_benchmarking.py`. Run against `rigor_classification_v1_2026-07-17.csv`.
...
|---|---|---|
| Most Demanding | 2,358 | 1,182 |
| Very Demanding | 2,552 | 1,151 |
| Demanding | 2,378 | 1,138 |
| Below Average | 1,359 | 1,137 |
| Average | 2,301 | 1,130 |

Mostly monotonic by rigor tier, with one small exception: "Below Average" (1,137) sits
slightly above "Average" (1,130) — small enough (7 points, smallest group in the table at
n=1,359) to read as noise rather than a real inversion, but worth naming rather than smoothing
into "clean monotonic relationship."
...
5.5x stronger than the rigor tier's (-0.070, from `RIGOR_CLASSIFICATION.md`).** That's not a
coincidence — it's exactly what the report's literature review (Sections 2.2, 2.4) predicts:
an outcome/achievement measure (SAT) is far more socioeconomically confounded than an
opportunity-structure measure built from offerings and participation (the rigor tier). This is
