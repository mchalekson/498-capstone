...
Vintages are those actually consumed by the frozen artifacts, not the publisher's current release.

{\small\raggedright
\begin{longtable}{@{}p{3.4cm}p{2.9cm}p{5.6cm}@{}}
\toprule
Source & Vintage consumed & Contribution \\
\midrule
\endfirsthead
\toprule
Source & Vintage consumed & Contribution \\
\midrule
\endhead
NCES CCD \citep{nces_ccd} & current release & Public school universe, enrollment, locale \\
NCES PSS \citep{nces_pss} & current release & Private school universe (49-state merge) \\
NCES ELSI \citep{nces_elsi} & current release & Extraction tool; 12-digit NCESSCH re-pull \\
CRDC \citep{ocr_crdc} & SY 2021--22 & AP, IB, dual enrollment, SAT/ACT, STEM, certification \\
EDFacts \citep{edfacts} & SY 2020--21 & Graduation rate; assessment participation \\
Census F-33 \citep{census_f33} & FY 2024 & District revenue \\
Census SAIPE \citep{census_saipe} & 2024 & County and district child poverty \\
Census ACS \citep{census_acs} & 2020--2024 & County neighborhood context \\
NAEP \citep{naep} & 2024 & National and state context (not school grain) \\
College Board AP \citep{collegeboard_ap} & 2024--25 & National and state aggregates only \\
IB Organization \citep{ib_org} & 2025--26 scrape & IB World School directory \\
ISBE Report Card \citep{isbe_reportcard} & 2025 & Illinois ACT and per-pupil expenditure \\
CPS Opportunity Index \citep{cps_opportunity} & SY 2026 & Chicago pilot region \\
IPEDS HD2023 \citep{ipeds_hd2023} & 2023 & College geography and Carnegie level \\
College Scorecard \citep{college_scorecard} & 2023--24 & College outcomes and price \\
OPE DAPIP \citep{ope_id} & current release & College identifier system \\
UC Boulder crosswalk \citep{ucboulder_crosswalk} & rev.\ 2025-01-06 & NCES-to-CEEB seed, 21{,}391 schools \\
NU organization export \citep{nu_org_export} & 2026-07-31 & School-level AP, SAT, placement, context \\
\bottomrule
\end{longtable}}\addtocounter{table}{-1}
